    ...
    <main className="min-h-screen relative text-white selection:bg-[#FF007F] selection:text-white">
      ...
      <section style={{
        ...
        <div style={{
          ...
          >
            <source src="/article.mp4" type="video/mp4" />
          </video>
          <div style={{
            position: 'absolute',
            inset: 0,
            background: 'linear-gradient(to bottom, rgba(2, 6, 23, 0.5) 0%, rgba(2, 6, 23, 0.6) 50%, rgba(2, 6, 23, 0.95) 100%)', // Adjusted overlay
          }} />
        </div>

        <div style={{ maxWidth: '1200px', margin: '0 auto', textAlign: 'center', width: '100%', position: 'relative', zIndex: 10 }}>
          <Reveal width="100%">
            <InboxBadge text="ARTICLES & INSIGHTS" />

            <h1 style={{
              fontSize: 'clamp(32px, 5vw, 54px)', // Reduced size per request
              fontWeight: 900,
              color: '#ffffff',
              marginBottom: '32px',
              lineHeight: 1.1,
            ...
            <Reveal delay={0.4}>
              <p style={{
                fontSize: '16px', // Reduced size per request
                color: '#e2e8f0',
                maxWidth: '700px',
                margin: '0 auto 40px',
                lineHeight: 1.8,
